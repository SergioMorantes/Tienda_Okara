      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade" id="user-settings">
          <div class="tile user-settings">
            <h4 class="line-head">Datos Complementarios</h4>
            <form id="formDatosComplementarios" name="formDatosComplementarios">
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-6">
                  <label>Barrio</label>
                  <input class="form-control" type="text" id="txtBarrio" name="txtBarrio" value="<?= $_SESSION['userData']['nombrebarrio']; ?>" >
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 mb-4">
                  <label>Ciudad</label>
                  <input class="form-control" type="text" id="txtCiudad" name="txtCiudad" value="<?= $_SESSION['userData']['ciudad']; ?>">
                </div>
              </div>
              <div class="row mb-10">
                <div class="col-md-12">
