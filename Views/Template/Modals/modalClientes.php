    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="formCliente" name="formCliente" class="form-horizontal">
              ...
              <hr>
              <p class="text-primary">Datos Complementarios.</p>
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" id="txtBarrio" name="txtBarrio" required="">
                </div>

                <div class="form-group col-md-12">
                  <label>Ciudad <span class="required">*</span></label>
                  <input class="form-control" type="text" id="txtCiudad" name="txtCiudad" required="">
                </div>
